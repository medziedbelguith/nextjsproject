...
export default function Login(){
    ...
    return (
        ...
        <button className={styles.button} onClick={signUp}>Sign In</button>
        <hr/>
        <button className={styles.googleAlt} onClick={signUpWithGoogle}>Sign up with Google</button>
        <hr/>
        <button className={styles.googleAlt} onClick={signUpWithGithub}>Sign up with Github</button>
        </main>
      </div>
    )
}